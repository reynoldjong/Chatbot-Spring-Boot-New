...
public class IndexerTest {
  ...
  public void testIndexDoc() throws IOException {
    indexer.indexDoc("The Life of Pie", "Something something tiger, boat, stranded.");
    indexer.indexDoc("Operating Systems", "Context switch is the process where the CPU is passed between processes...");
    indexer.indexDoc("Learning Haskell", "Learning Haskell is as easy as 1, 2, lol you're dead");
