...
public class Indexer {
  ...
  public static void main(String[] args) {
     ...
     * testJournalHash.put("Journal entry 3",
     * "Wow, it is still raining today.");
    ...
    /*
     * testHeaderHash.put("Work schedule day 1",
     * "Write unit test for my indexer");
     ...
     * testHeaderHash.put("Work schedule day 4",
     * "Continuing to write my indexer");
    ...
    try {
      ...
      // myIndexer.indexDoc("The Life of Pie", "Something something tiger, boat,
      // stranded.");
      // myIndexer.indexDoc("Operating Systems", "Context switch is the process
      // where the CPU is passed between processes...");
      // myIndexer.indexDoc("Learning Haskell", "Learning Haskell is as easy as
      // 1, 2, lol you're dead");
    } catch (IOException e) {
