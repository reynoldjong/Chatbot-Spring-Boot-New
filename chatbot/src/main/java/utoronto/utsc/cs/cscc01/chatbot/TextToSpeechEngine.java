...
public class TextToSpeechEngine {
  ...
  public byte[] createAudioFromText(String text) throws IOException {
      ...
      InputStream inputStream = watsonTTS.getTTS().synthesize(synthesizeOptions).execute().getResult();
  ...
  public static void main(String[] args) throws IOException {
    ...
    //ttsEngine.createAudioFromText("Hello World, How are you doing today? What is DFI? What is context switch? How long can this go on for?");
  }
}
