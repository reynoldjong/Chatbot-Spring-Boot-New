    ...
    return(
        <div>
             ...
             <Paper className={classes.root} id="out" style={{height:'500px'}}>
                ...
                <Message text="hello this is some text llo this is some text how loollo this is some text how loollo this is some text how loollo this is some text how loohow look" type='bot' picture={robot} />
